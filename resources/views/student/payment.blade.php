        ...
        <div class="row">
            ...
            <div class="col-12 col-lg-8">
                <div class="single-course-wrap">
                    ...
                    <form action="/feedbacks" method="post" name="myForm" enctype="multipart/form-data">
  @csrf
  
    <label for="code">Feedback</label>
    <input type="text" id="feedback" name="feedback" class="av-name"  placeholder="feedback.." av-message="only chracters" required="" autocomplete="off">
     <br>
     <br>                  
