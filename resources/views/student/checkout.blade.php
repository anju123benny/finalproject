...
<!-- Meta tag Keywords -->
<!-- css files -->
<link href="checkouts/css/style.css" rel="stylesheet" type="text/css" media="all" />
<link rel="stylesheet" href="checkouts/css/creditly.css" type="text/css" media="all" />
<link rel="stylesheet" href="checkouts/css/font-awesome.css"> <!-- Font-Awesome-Icons-CSS -->
<!-- //css files -->
<!-- Web Fonts -->
<link href="checkouts///fonts.googleapis.com/css?family=Josefin+Sans:100,100i,300,300i,400,400i,600,600i,700,700i&amp;subset=latin-ext" rel="stylesheet">
<!-- //Web Fonts -->
</head>
<body>
<div class="main">	
...
<!-- js scripts --> 
<!-- js -->
	<script type="text/javascript" src="checkouts/js/jquery-2.1.4.min.js"></script>
<!-- //js -->
<!-- credit-card -->
	<script type="text/javascript" src="checkouts/js/creditly.js"></script>
