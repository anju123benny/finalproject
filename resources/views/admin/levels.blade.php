...
.container {
 ...
 height:100%;
    ...
    <div class="sidebar sidebar-hide-to-small sidebar-shrink sidebar-gestures">
        ...
        <h2><center><font color="#990066">Add Level Details</font></center></h2>   		

<div class="container">
 <form action="/savelevels" method="post" enctype="multipart/form-data">
 @csrf
 <label for="code">Course</label>
   ...
   <input type="text" id="name" name="name" placeholder="Course levels..">
