...
<head>
  ...
  <link rel="admin/stylesheet" type="text/css" href="admin/css/zabuto_calendar.css">
  <link rel="admin/stylesheet" type="text/css" href="admin/lib/gritter/css/jquery.gritter.css" />
...
<body>
  <section id="container">
    ...
    <header class="header black-bg">
      ...
      <!--logo start-->
      <a href="../main" class="logo"><b>COU<span>RSE</span></b></a>
      <!--logo end-->
        ...
        <ul class="nav top-menu">
          ...
          <li id="header_inbox_bar" class="dropdown">
            ...
            <ul class="dropdown-menu extended inbox">
              ...
              <li>
                <a href="../main">See all messages</a>
              </li>
            </ul>
          </li>
          <!-- inbox dropdown end -->
          ...
          <li id="header_notification_bar" class="dropdown">
            ...
            <ul class="dropdown-menu extended notification">
              ...
              <li>
                <a href="../main">See all notifications</a>
              </li>
            </ul>
          </li>
    ...
    <aside>
      <div id="sidebar" class="nav-collapse ">
        ...
        <p class="centered"><a href="admin/profile.html"><img src="admin/img/as.jpg" class="img-circle" width="80"></a></p>
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              <li><a href="/savecourse">General</a></li>
              <li><a href="/savelevels">Buttons</a></li>
              <li><a href="/detailss">Panels</a></li>
