...
<div class="container">
 ...
 <label for="code">Number of Question</label>
 <input type="text" id="question" name="nquestion" placeholder=" No Qusetions..">
<label for="code">Set time</label>
