...
<div class="container">
  <form action="/savechapter" method="post" name="myForm" enctype="multipart/form-data">
  @csrf
  ...
  <label for="code">Course</label>
   ...
   <select class="form-control" name="level"  required="">
         ...
         <label for="code">Chapters</label>
    <input type="text" id="name" name="chaptername" placeholder="Chapter Name..">
