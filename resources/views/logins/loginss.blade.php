...
<!-- Meta_tag_Keywords -->
<link href="log/css/style.css" rel="stylesheet" type="text/css" media="all"><!--style_sheet-->
<link href="log/css/font-awesome.min.css" rel="stylesheet" type="text/css" media="all"><!--font_awesome_icons-->
<!--web_fonts-->
<link href="log///fonts.googleapis.com/css?family=Raleway:100,200,300,400,500,600,700,800,900&amp;subset=latin-ext" rel="stylesheet">
<!--//web_fonts-->
</head>
<body>
<div class="form">
<h1>Connective Login Form</h1>
	<div class="form-content">
		<form action="/logins_login" method="post">
		@csrf
			<div class="form-info">
				<h2>Login</h2>
			</div>
