...
class ResultController extends Controller
{
    ...
    public function create()
    {
        ...
        $getCourseName=Examinfos::where('uniqueid',$getExamCode)->value('Course');
        $getScore=Students::where(
            ['student_id'=>$getId,
        ...
        $answeredQuestion=Answers::where('stu_id',$findStudentIdForAnswerSheet)->get();
